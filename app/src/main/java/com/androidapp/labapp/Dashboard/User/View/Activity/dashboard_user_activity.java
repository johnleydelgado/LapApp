package com.androidapp.labapp.Dashboard.User.View.Activity;
...
//    }
    ...
    private void selectedFragment(int item){

        switch (item){
            case 1:
                getSupportFragmentManager().
                        beginTransaction().
                        replace(R.id.fragment_view, new user_profile_fragment()).commit();
                break;
            case 2:
                getSupportFragmentManager().
                        beginTransaction().
                        replace(R.id.fragment_view, new user_patient_listview()).commit();
                break;
            case 3:
                getSupportFragmentManager().
                        beginTransaction().
